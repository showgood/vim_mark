...
if !hasmapto('<Plug>MarkClear', 'n')
	nmap <unique> <silent> <leader><leader>n <Plug>MarkClear
endif
...
nnoremap <silent> <leader><leader>/ :call <sid>SearchAnyMark()<cr>
nnoremap <silent> <leader><leader>? :call <sid>SearchAnyMark("b")<cr>
